  ...
  return (
    <div className="flex flex-col min-h-screen relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-full max-w-5xl opacity-20 dark:opacity-10 z-0 pointer-events-none">
        <Image src="/ai-particles.svg" width={850} height={850} alt="AI Network Visualization" />
      </div>
              ...
              <div className="hero-statement-container">
                <div className="hero-statement-card">
                  ...
                  <h1 className="hero-statement-text">
                    ...
                    <span className="hero-highlight"> human-machine-environment synthesis</span>
                    —enabling ethical autonomy in intelligent infrastructures and 
                    <span className="hero-highlight"> human-machine collaboration</span>.
                  </h1>
                </div>
              </div>
        ...
        <section id="about" className="section-container section-light">
          <div className="container mx-auto px-6 max-w-7xl">
            <div className="text-center mb-20">
              ...
              <p className="section-subtitle">Redefining research through open exploration and collaborative innovation</p>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 xl:gap-16">
              ...
              <div className="glassmorphism-card p-10 lg:p-12 space-y-6">
                <div className="flex items-center space-x-4 mb-6">
                  ...
                  <h3 className="text-2xl font-bold text-secondary-enhanced">The Problem</h3>
                </div>
                <h4 className="text-xl font-semibold text-muted-enhanced mb-4">Closed Doors, Narrow Paths</h4>
                ...
                <div className="space-y-4">
                  <div className="problem-item">
                    ...
                    <div>
                      <strong>Access barriers</strong>: Fixed application cycles and GPA cutoffs exclude self-motivated learners
                    </div>
                  </div>
                  <div className="problem-item">
                    <div className="problem-icon">
                    ...
                    <div>
                      <strong>Narrow scope</strong>: Overly specialized projects limit interdisciplinary growth
                    </div>
                  </div>
                  <div className="problem-item">
                    <div className="problem-icon">
                    ...
                    <div>
                      <strong>Uncertain fit</strong>: Students hesitate to commit without testing diverse research approaches
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="glassmorphism-card p-10 lg:p-12 space-y-6">
                <div className="flex items-center space-x-4 mb-6">
                  ...
                  <h3 className="text-2xl font-bold text-secondary-enhanced">Our Solution</h3>
                </div>
                <h4 className="text-xl font-semibold text-emphasized mb-4">Open Exploration</h4>
                <p className="text-lg text-body mb-6">
                ...
                <div className="space-y-4">
                  <div className="solution-item">
                    ...
                    <div>
                      <strong>Continuous Intake</strong>: Join anytime—no rigid deadlines or semesters
                    </div>
                  </div>
                  <div className="solution-item">
                    <div className="solution-icon">
                    ...
                    <div>
                      <strong>Diverse Focus Areas</strong>: Contribute to ongoing projects or propose your own ideas
                    </div>
                  </div>
                  <div className="solution-item">
                    <div className="solution-icon">
                    ...
                    <div>
                      <strong>Purpose-Driven Impact</strong>: Prioritize meaningful innovation over publication volume
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 xl:gap-16 mt-16">
              ...
              <div className="glassmorphism-card p-10 lg:p-12">
                <div className="flex items-center space-x-4 mb-8">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-secondary-enhanced">Mentorship</h3>
                    <p className="text-emphasized">Guidance Tailored to You</p>
                  </div>
                </div>
                <div className="space-y-6">
                  <div className="mentorship-feature">
                    <h4 className="font-semibold text-secondary-enhanced mb-2">Accessible Experts</h4>
                    <p className="text-body">Consult mentors actively engaged in both academia and industry</p>
                  </div>
                  <div className="mentorship-feature">
                    <h4 className="font-semibold text-secondary-enhanced mb-2">Collaborative Support</h4>
                    <p className="text-body">Peer and mentor-reviewed work, cross-project workshops, and open lab resources</p>
                  </div>
                  <div className="mentorship-feature">
                    <h4 className="font-semibold text-secondary-enhanced mb-2">Skill Development</h4>
                    <p className="text-body">Gain expertise through collaborative coding standards and hands-on learning</p>
                  </div>
                </div>
              </div>
              ...
              <div className="glassmorphism-card p-10 lg:p-12">
                <div className="flex items-center space-x-4 mb-8">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-secondary-enhanced">Structured Autonomy</h3>
                    <p className="text-emphasized">Progress through collaboration</p>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div className="tier-item">
                    ...
                    <div>
                      <strong>New Member</strong>: Immerse in lab culture and develop foundational skills
                    </div>
                  </div>
                  <div className="tier-item">
                    <div className="tier-badge tier-active">2</div>
                    <div>
                      <strong>Active Member</strong>: Contribute to projects and collaborate with peers
                    </div>
                  </div>
                  <div className="tier-item">
                    <div className="tier-badge tier-mentor">3</div>
                    <div>
                      <strong>Mentor</strong>: Guide others while deepening technical abilities
                    </div>
                  </div>
                  <div className="tier-item">
                    <div className="tier-badge tier-lead">4</div>
                    <div>
                      <strong>Project Lead</strong>: Oversee initiatives and drive innovation
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section id="projects" className="section-container section-dark">
          <div className="container mx-auto px-6 max-w-7xl">
            <div className="text-center mb-20">
              ...
              <p className="section-subtitle">Advancing AI perception through innovative research initiatives</p>
            </div>
        ...
        <section id="team" className="section-container section-light">
          <div className="container mx-auto px-6 max-w-6xl">
            <div className="text-center mb-20">
              ...
              <p className="section-subtitle">Meet the researchers driving innovation in AI perception</p>
            </div>
              ...
              <div className="team-category">
                ...
                <div className="team-members">
                  <div className="empty-state">
                    ...
                    <a href="#apply" className="empty-cta">Apply Now</a>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section id="publications" className="section-container section-dark">
          <div className="container mx-auto px-6 max-w-4xl">
            <div className="text-center mb-20">
              ...
              <p className="section-subtitle">Research contributions and academic publications</p>
            </div>
            ...
            <div className="publications-placeholder">
              ...
              <div className="placeholder-actions">
                <a href="#contact" className="placeholder-button">Get Notified</a>
              </div>
            </div>
          </div>
        </section>
        ...
        <section id="contact" className="section-container section-light">
          <div className="container mx-auto px-6 max-w-6xl">
            <div className="text-center mb-20">
              ...
              <p className="section-subtitle">Ready to collaborate? Let's explore opportunities together</p>
            </div>
                ...
                <div className="contact-methods">
                  <div className="contact-method">
                    ...
                    <div className="contact-details">
                      ...
                      <span className="contact-value">contact@aiperceptionlab.com</span>
                    </div>
                  </div>
        ...
        <section id="apply" className="section-container section-dark">
          <div className="container mx-auto px-6 max-w-5xl">
            <div className="text-center mb-20">
              ...
              <p className="section-subtitle">Ready to start your research journey? Follow these simple steps</p>
            </div>
            ...
            <div className="application-process">
              <div className="process-step">
                ...
                <div className="step-content">
                  ...
                  <a href="https://www.notion.so/invite/ba441204434aca1a59ff22cb546b93b1feac30b4" 
                     className="step-link" target="_blank" rel="noopener noreferrer">
              ...
              <div className="process-step">
                ...
                <div className="step-content">
                  ...
                  <p className="step-description">
                    Submit a request to join the <strong>AI Perception Lab Teamspace</strong> through Notion.
                  </p>
                </div>
              </div>
            ...
            <div className="application-cta">
              <p className="cta-text">Questions about the application process?</p>
          ...
          <div className="footer-content">
            <div className="footer-info">
              ...
              <p className="footer-copyright">
                © 2025 Artificial Intelligence Perception Lab. All rights reserved.
              </p>
            </div>
